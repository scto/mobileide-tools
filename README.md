# Build Tools for [MobileIDE](https://github.com/scto/MobileIDE).
<a href="https://github.com/scto/MobileIDE"><img src="https://androidide.com/github/img/androidide.php?part&for-the-badge"/></a><br>

This repository includes JDK 11 (now _**deprecated**_), Android SDK and tools for MobileIDE. An installation script is also available which you can use to easily install the tools.
```
MobileIDE build tools installer
This script helps you easily install build tools in MobileIDE.
...
-m   Manifest file URL. Defaults to 'manifest.json' in 'mobileide-tools' GitHub repository.
...
## Installing in MobileIDE
- Open the MobileIDE terminal.
...
## Download
You can manually download and install these tools from [releases](https://github.com/scto/androidide-build-tools/releases). A step-by-step guide is available on [our blog](https://androidide.com/blogs/getting-started/2023/07/17/manually-installing-build-tools-in-androidide/).
